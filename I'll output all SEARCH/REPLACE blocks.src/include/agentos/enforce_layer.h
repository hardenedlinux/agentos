#ifndef AGENTOS_ENFORCE_LAYER_H
#define AGENTOS_ENFORCE_LAYER_H
...
/**
 * @brief Deterministic EnforceLayer – security and resource decisions.
 *
 * EnforceLayer decisions are never influenced by LLM output.
