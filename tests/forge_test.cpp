...
TEST (ForgeJobTest, DefaultValues)
{
  ...
  EXPECT_STREQ (job.phase.c_str (), "");
  EXPECT_STREQ (job.last_code.c_str (), "");
  EXPECT_STREQ (job.last_feedback.c_str (), "");
...
TEST (ForgeStateMachineTest, DraftingToReviewing)
{
  ...
  ForgeStateMachine sm ([&] (ForgeJob &) { draftCalled = true; },
...
TEST (ForgeStateMachineTest, ReviewingToSandboxProbe)
{
  ...
  ForgeStateMachine sm ([] (ForgeJob &) {}, [&] (ForgeJob &)
                        { reviewCalled = true; }, [&] (ForgeJob &)
                        { probeCalled = true; }, [] (ForgeJob &) {},
                        [] (ForgeJob &) {}, [] (ForgeJob &) {});
...
TEST (ForgeStateMachineTest, ApprovedToPromoted)
{
  ...
  ForgeStateMachine sm ([] (ForgeJob &) {}, [] (ForgeJob &) {},
                        [] (ForgeJob &) {}, [&] (ForgeJob &)
                        { approveCalled = true; }, [&] (ForgeJob &)
                        { promoteCalled = true; }, [] (ForgeJob &) {});
